...
define('ADDRESS_ADMIN', 'http://' . $_SERVER['SERVER_NAME'] . dirname($_SERVER['SCRIPT_NAME']). '/admin/');



define('ADDRESS', 'http://' . $_SERVER['SERVER_NAME'] . dirname($_SERVER['SCRIPT_NAME']). '/');
...
define('ADDRESS_GALLERY', 'http://' . $_SERVER['SERVER_NAME'] .dirname($_SERVER['SCRIPT_NAME']). '/files/gallery/');
...
define('ADDRESS_SLIDES', 'http://' . $_SERVER['SERVER_NAME'] . dirname($_SERVER['SCRIPT_NAME']). '/files/slides/');

define('ADDRESS_ADS', 'http://' . $_SERVER['SERVER_NAME'] .dirname($_SERVER['SCRIPT_NAME']). '/files/adss/');
...
define('DIR_ABS', $_SERVER["DOCUMENT_ROOT"] .dirname($_SERVER['SCRIPT_NAME']). '/');
...
define('DB_USER', 'xncfblzdfe_petc');
...
define('DB_DEFAULT', 'xncfblzdfe_petc');
