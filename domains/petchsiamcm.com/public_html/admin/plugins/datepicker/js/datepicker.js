    ...
    (function () {
        ...
        D.Body.prototype = {
            ...
            _getCellContents: function (date, type) {
                ...
                if (opts.range) {
                    if (D.isSame(parent.minRange, date, type))
                        classes += ' -range-from-';
                    if (D.isSame(parent.maxRange, date, type))
                        classes += ' -range-to-';
                ...
                if (D.isSame(currentDate, date, type))
                    classes += ' -current-';
                if (parent.focused && D.isSame(date, parent.focused, type))
                    classes += ' -focus-';
